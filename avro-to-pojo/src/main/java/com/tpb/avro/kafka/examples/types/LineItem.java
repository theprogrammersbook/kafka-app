...
public class LineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3445368098436560436L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LineItem\",\"namespace\":\"com.tpb.avro.kafka.examples.types\",\"fields\":[{\"name\":\"ItemCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"ItemDescription\",\"type\":[\"null\",\"string\"]},{\"name\":\"ItemPrice\",\"type\":[\"null\",\"double\"]},{\"name\":\"ItemQty\",\"type\":[\"null\",\"int\"]},{\"name\":\"TotalValue\",\"type\":[\"null\",\"double\"]}]}");
   ...
   */
  public static com.tpb.avro.kafka.examples.types.LineItem.Builder newBuilder() {
    return new com.tpb.avro.kafka.examples.types.LineItem.Builder();
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static com.tpb.avro.kafka.examples.types.LineItem.Builder newBuilder(com.tpb.avro.kafka.examples.types.LineItem.Builder other) {
    return new com.tpb.avro.kafka.examples.types.LineItem.Builder(other);
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static com.tpb.avro.kafka.examples.types.LineItem.Builder newBuilder(com.tpb.avro.kafka.examples.types.LineItem other) {
    return new com.tpb.avro.kafka.examples.types.LineItem.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.tpb.avro.kafka.examples.types.LineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.tpb.avro.kafka.examples.types.LineItem other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.ItemCode)) {
        this.ItemCode = data().deepCopy(fields()[0].schema(), other.ItemCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.LineItem.Builder setItemCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.LineItem.Builder clearItemCode() {
      ItemCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.LineItem.Builder setItemDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.LineItem.Builder clearItemDescription() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.LineItem.Builder setItemPrice(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.LineItem.Builder clearItemPrice() {
      ItemPrice = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.LineItem.Builder setItemQty(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.LineItem.Builder clearItemQty() {
      ItemQty = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.LineItem.Builder setTotalValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.LineItem.Builder clearTotalValue() {
      TotalValue = null;
