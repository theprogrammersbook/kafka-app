...
public class DeliveryAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4618783019364947987L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DeliveryAddress\",\"namespace\":\"com.tpb.avro.kafka.examples.types\",\"fields\":[{\"name\":\"AddressLine\",\"type\":[\"null\",\"string\"]},{\"name\":\"City\",\"type\":[\"null\",\"string\"]},{\"name\":\"State\",\"type\":[\"null\",\"string\"]},{\"name\":\"PinCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"ContactNumber\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public static com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder newBuilder() {
    return new com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder();
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder newBuilder(com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder other) {
    return new com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder(other);
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder newBuilder(com.tpb.avro.kafka.examples.types.DeliveryAddress other) {
    return new com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeliveryAddress>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.tpb.avro.kafka.examples.types.DeliveryAddress other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.AddressLine)) {
        this.AddressLine = data().deepCopy(fields()[0].schema(), other.AddressLine);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder setAddressLine(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder clearAddressLine() {
      AddressLine = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder clearCity() {
      City = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder clearState() {
      State = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder setPinCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder clearPinCode() {
      PinCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder setContactNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tpb.avro.kafka.examples.types.DeliveryAddress.Builder clearContactNumber() {
      ContactNumber = null;
